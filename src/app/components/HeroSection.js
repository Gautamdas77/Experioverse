...
const PILLS = [
  { label: 'Employee Engagement', color: '#EE92D0' },
  { label: 'Team Building',       color: '#5D4781' },
  { label: 'Corporate Events',    color: '#9B7EC8' },
  { label: 'Wellness Programs',   color: '#10b981' },
  { label: 'Corporate Offsites',  color: '#E066BA' },
  { label: 'Sports & Fun',        color: '#7A5FA8' },
];
  ...
  return (
    <section
      ...
      style={{
        ...
        overflow: 'hidden',
        background: 'linear-gradient(135deg, #100C1E 0%, #1A1330 30%, #231B35 65%, #2E2148 100%)',
      }}
    >
      {/* ── CSS keyframes ── */}
      <style>{`
      ...
      <div style={{ position:'absolute', inset:0, zIndex:0, pointerEvents:'none' }}>
        ...
        <div style={{
          ...
          background:'radial-gradient(circle, rgba(238,146,208,0.30) 0%, transparent 65%)',
          filter:'blur(60px)',
        ...
        <div style={{
          ...
          background:'radial-gradient(circle, rgba(93,71,129,0.40) 0%, transparent 65%)',
          filter:'blur(55px)',
          animation:'aurora2 11s ease-in-out infinite',
        }} />
        {/* blob 3 — rose-pink centre */}
        <div style={{
          position:'absolute', top:'38%', left:'40%',
          width:450, height:450, borderRadius:'50%',
          background:'radial-gradient(circle, rgba(224,102,186,0.20) 0%, transparent 68%)',
          filter:'blur(65px)',
        ...
        <div style={{
          ...
          height:1,
          background:'linear-gradient(90deg, transparent 0%, rgba(238,146,208,0.10) 30%, rgba(238,146,208,0.10) 70%, transparent 100%)',
        }} />
      </div>
      ...
      <div style={{ maxWidth:1280, margin:'0 auto', padding:'0 1.5rem', width:'100%', position:'relative', zIndex:10, paddingTop:'8rem', paddingBottom:'5rem' }}>
        ...
        >
          <div style={{
            ...
            background:'rgba(238,146,208,0.12)',
            border:'1px solid rgba(238,146,208,0.35)',
            ...
            <span style={{ position:'relative', display:'flex', width:9, height:9 }}>
              ...
              <span style={{
                ...
                width:9, height:9, background:'#EE92D0', display:'block',
              }} />
            </span>
        ...
        >
          ...
          <span
            style={{
              backgroundImage:'linear-gradient(90deg, #EE92D0 0%, #5D4781 100%)',
        ...
        >
          ...
          <span
            style={{
              backgroundImage:'linear-gradient(90deg, #EE92D0 0%, #9B7EC8 100%)',
              WebkitBackgroundClip:'text',
              WebkitTextFillColor:'transparent',
              backgroundClip:'text',
              fontWeight:600,
        ...
        >
          <Link
            ...
            style={{
              ...
              color:'#231B35', fontWeight:700, fontSize:15,
              textDecoration:'none',
              boxShadow:'0 8px 32px rgba(238,146,208,0.45)',
              transition:'transform 0.2s ease, box-shadow 0.2s ease',
            }}
            onMouseEnter={e => { e.currentTarget.style.transform='translateY(-2px)'; e.currentTarget.style.boxShadow='0 14px 40px rgba(238,146,208,0.65)'; }}
            onMouseLeave={e => { e.currentTarget.style.transform='translateY(0)'; e.currentTarget.style.boxShadow='0 8px 32px rgba(238,146,208,0.45)'; }}
          >
          ...
          {STATS.map((s, i) => (
            ...
            >
              <div style={{
                ...
                fontWeight:800,
                backgroundImage:'linear-gradient(90deg, #EE92D0, #9B7EC8)',
                WebkitBackgroundClip:'text',
                WebkitTextFillColor:'transparent',
                backgroundClip:'text',
                marginBottom:6,
